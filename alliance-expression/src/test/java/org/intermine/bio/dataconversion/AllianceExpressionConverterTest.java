...
public class AllianceExpressionConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    AllianceExpressionConverter converter;
    MockItemWriter itemWriter;

    public AllianceExpressionConverterTest(String arg) {
        super(arg);
    }
