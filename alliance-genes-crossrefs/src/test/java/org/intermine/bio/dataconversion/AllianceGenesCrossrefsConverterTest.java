...
public class AllianceGenesCrossrefsConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    AllianceGenesCrossrefsConverter converter;
    MockItemWriter itemWriter;

    public AllianceGenesCrossrefsConverterTest(String arg) {
        super(arg);
    }
