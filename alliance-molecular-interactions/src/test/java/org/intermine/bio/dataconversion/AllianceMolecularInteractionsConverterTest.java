...
public class AllianceMolecularInteractionsConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    AllianceMolecularInteractionsConverter converter;
    MockItemWriter itemWriter;

    public AllianceMolecularInteractionsConverterTest(String arg) {
        super(arg);
    }
