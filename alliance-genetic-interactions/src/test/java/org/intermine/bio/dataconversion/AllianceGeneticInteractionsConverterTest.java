...
public class AllianceGeneticInteractionsConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    AllianceGeneticInteractionsConverter converter;
    MockItemWriter itemWriter;

    public AllianceGeneticInteractionsConverterTest(String arg) {
        super(arg);
    }
